    ...
    <>
      ...
      {showFullscreenQr && (
        <div className="fixed inset-0 z-[999] flex flex-col items-center justify-center gap-6 bg-white p-6 animate-[fade-up_0.3s_ease-out_both]">
          ...
          />
          <p className="text-xs text-text-muted">QR akan otomatis diperbarui bila kedaluwarsa — tidak perlu refresh halaman.</p>
          <button
            onClick={handleStop}
